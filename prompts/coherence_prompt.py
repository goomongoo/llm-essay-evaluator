...
Your task is to assess the *coherence quality* of an essay based on a structured evaluation plan.
...
1. **Intra-paragraph Structure Appropriateness**
...
2. **Inter-paragraph Structure Appropriateness**
...
3. **Structural Consistency and Logical Flow**
...
Step through each criterion, assign a score from 0–3, and briefly justify the score (1–2 sentences per criterion). Then, add up the three scores and print the total. Only output a single integer from 0 to 9 at the end.
...
Now follow this format and evaluate the next essay:
