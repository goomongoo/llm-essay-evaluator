...
1. Grammatical Accuracy: Are there any grammatical mistakes? Is the grammar consistent and correct throughout the essay?
2. Appropriateness of Word Choice: Are the words appropriate for the context? Is the vocabulary diverse and used effectively?
3. Sentence Structure and Expression: Does the writing use a variety of sentence structures in a natural and fluent way? Are sentence lengths well-balanced, and are similar ideas expressed with flexibility and variation?
...
## PLAN ##
Step 1: Evaluate Grammatical Accuracy.
- Are there any grammatical mistakes?
- Is the grammar consistent and correct throughout the essay?
- Assign a score from 0 to 3.

Step 2: Evaluate Appropriateness of Word Choice.
- Are the words appropriate for the context?
- Is the vocabulary diverse and used effectively?
- Assign a score from 0 to 3.

Step 3: Evaluate Sentence Structure and Expression.
- Does the writing use a variety of sentence structures in a natural and fluent way?
- Are sentence lengths well-balanced, and are similar ideas expressed with flexibility and variation?
- Assign a score from 0 to 3.
